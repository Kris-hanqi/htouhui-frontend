<template>
  <div class="iNeedRechargeBox fr">
    ...
    <ul class="tabChangeUl clearFix">
      <li><a class="activeLi">快捷充值</a></li>
      <li><a>跨行转账</a></li>
      <li><a>支付宝转账</a></li>
    </ul>
    ...
    <!--支付宝转账-->
    <div class="alipayTransfer" style="display: none;">
    ...
    <!--跨行转账-->
    <div class="interBankTransfer" style="display: none;">
      <div class="alipayStep">
